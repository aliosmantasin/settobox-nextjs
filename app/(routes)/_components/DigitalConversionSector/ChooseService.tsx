    ...
    <section className="py-10 theme">
      ...
      <div className="overflow-x-auto mt-8 mx-auto p-2">
        ...
        >
          ...
          <h5 className="text-blue-600 font-medium mt-2">Meta Yönetimi</h5>
        </div>
        ...
        >
          ...
          <h5 className="text-blue-600 font-medium mt-2">Google Yönetimi</h5>
        </div>
        ...
        >
          ...
          <h5 className="text-blue-600 font-medium mt-2">Web Site Yönetimi</h5>
        </div>
