...
import GoogleMegaBox from "../../../../../public/mega-box.webp";
  ...
  return (
    <>
        ...
        <div className="boxTable">
                      ...
                      <div className="headerTable ">MegaBox Google Reklam Yönetimi</div>
                          ...
                          <div id="alert-additional-content-1" className="p-4 mb-4 text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800  m-1 sm:m-0" role="alert">
                              <div className="flex items-center">
                                  ...
                                  <h3 className="text-lg font-medium">Dengeli Bütçe Marka Bilinirliği Artışı</h3>
                              </div>
                              <div className="mt-2 mb-4 text-sm">
                              Bir aylık google ads Arama Ağı & Görüntülü Reklam Ağı yönetimidir. MegaBox içeriğinde google ads hesap kurulum desteği vardır.
                    ...
                    <AccordionContent>
                      ...
                      <div className="bodyTable p-2">
                        ...
                        <ul>
                          ...
                          <li>Google MegaBox içeriğinde aylık yönetim uygulanmaktadır.(1 AY)</li>
                        </ul>
                        ...
                        <ul>
                          ...
                          <li>Maksimum 3 adet kampanya kurulumu gerçekleştirilmektedir.</li>
                        </ul>
                        ...
                        <ul>
                          <li><span><Image src={GoogleMegaBox} width={35} alt="Google AdsReklamı: Mini Kutu" /></span>Google MegaBox İçeriği</li>
                          <li>Ürün/hizmet arayan internet kullanıcılarının anlık olarak karşılarına çıkmak, sekörel olarak marka biliniliğini artırmak ve derinlemesine etki yaparak web sitelerinine kullanıcı trafiği çekerek daha iyi hedeflemeler ile pazarlama taktikleri uygulamak için tasarlanmıştır.</li>
                        </ul>

                        <ul>
                          <li><span><ArrowBigRightDash/></span>Uygun Görülen Bütçe </li>
                          <li>Google MegaBox Reklam içeriğinde Arama Ağı - Duyarlı Reklam Ağı ve Retargeting reklamları kullanılmaktadır. Gösterime sunulacak reklamın çeşitli değişkenlikleri göz önünde bulundurulunca minumum ihtiyaç duyulan aylık bütçe 10.000(+) TL`dir.</li>
                        </ul>
