...
export function MobilMenu() {
  ...
  <div className="flex space-x-5 mt-5 border-b-2 p-2 border-black-500 ">
    ...
    <Button className="">Marka Kimliği</Button>
  </div>
    ...
    <NavigationMenuList className="flex flex-col space-y-5 mt-8 w-full">
      ...
      <NavigationMenuItem className="flex w-full max-w-96">
        <Link href="/" legacyBehavior passHref>
          <NavigationMenuLink className={cn(navigationMenuTriggerStyle(), "bg-transparent hover:bg-transparent text-[1rem]")}>
            Ana Sayfa
          </NavigationMenuLink>
        </Link>
      </NavigationMenuItem>
      ...
      <NavigationMenuItem className="flex w-full max-w-96">
        <NavigationMenuTrigger className={cn(navigationMenuTriggerStyle(), "bg-transparent hover:bg-transparent text-[1rem]")}>Hizmetler</NavigationMenuTrigger>
        <NavigationMenuContent className="">
          <ul className="grid gap-3 p-4">
            ...
            {serviceLinkData.singleService.map((item) => (
              <ListItem key={item.title} href={item.href} title={item.title} className="row-span-4">
      ...
      <NavigationMenuItem className="flex w-full max-w-96">
        <NavigationMenuTrigger className={cn(navigationMenuTriggerStyle(), "bg-transparent hover:bg-transparent text-[1rem]")}>Sektörler</NavigationMenuTrigger>
