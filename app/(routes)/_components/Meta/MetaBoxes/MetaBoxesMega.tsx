  ...
  return (
    <>
        ...
        <div className="boxTable">
                      ...
                      <div className="headerTable ">MegaBox Meta Reklam Yönetimi</div>
                          ...
                          <div id="alert-additional-content-1" className="p-4 mb-4 text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800 m-1 sm:m-0" role="alert">
                              <div className="flex items-center">
                                  ...
                                  <h3 className="text-lg font-medium">Stratejik Reklam Yaklaşımı</h3>
                              </div>
                              <div className="mt-2 mb-4 text-sm">
                              Aylık facebook/instagram reklam yönetimidir. MegaBox içeriğinde hesap kurulum desteği vardır. Kurumsal tasarım desteği vardır.
                              </div>
                    ...
                    <AccordionContent>
                      ...
                      <div className="bodyTable p-2 ">
                        ...
                        <ul>
                          ...
                          <li>MegaBox içeriğinde bir ay reklam süresi belirlenmiştir. Reklam bütçesi süreye göre optimize edilebilir.</li>
                        </ul>
                        ...
                        <ul>
                          ...
                          <li>MegaBox`ta maksimum 3 adet kampanya kurulumu yapılmaktadır.</li>
                        </ul>

                        <ul>
                          <li><span><ArrowBigRightDash/></span>Kampanya Denetimi</li>
                          <li>3 adet kampanyaya göre denetim yapılmaktadır. Kampanyalarınızın performansını izlemek, optimize etmek ve iyileştirmek için yapılan çeşitli analiz ve ayar işlemlerini içerir.
                        ...
                        <ul>
                          ...
                          <li>
                          MegaBox meta reklam yönetiminde özel hedef kitle reklam stratejisine göre tercih edilebilir.
                          </li>
                        </ul>
                        <ul>
                          <li><span><ArrowBigRightDash/></span>Benzer Hedef Kitle</li>
                          <li>MegaBox meta reklam yönetiminde benzer hedef kitle kullanılmaktadır. Belirli bir reklam gösteriminden sonra oluşmaktadır.</li>
                        </ul>
                        <ul>
                        ...
                        <ul>
                          <li><span><Image src={MegaBox} width={35} alt="Sosyal Medya Reklamı: Mini Kutu" /></span>MegaBox İçeriği</li>
                          <li>
                          Meta uygulamalarının derinlemesine kullanıldığı bu hizmete ek olarak aktif bir web site hizmeti ile destekleyici yapı oluşturulmaktadır.</li>
                        </ul>

                        <ul>
                          <li><span><ArrowBigRightDash/></span>Uygun  Görülen Bütçe </li>
                          <li>MegaBox için minimum 10.000₺ bütçe uygun görülmektedir. Bütçe; işlenen reklam stratejisine göre belirlenmektedir. 1 Ay`ın her gününe göre ya da belirlenen günlere göre bütçe optimizasyonu yapılarak bütçeye göre de uygun strateji uygulanabilmektedir.</li>
                        </ul>
