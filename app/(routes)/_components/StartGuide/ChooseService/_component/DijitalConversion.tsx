       ...
       <div className=" flex w-full m-auto">
            <Table>
                ...
                <TableCaption className="text-center sm:text-start">
                    Meta, Google ve Web Site hizmetlerin tümüyle ve birbiriyle entegre bir şekilde yönettiğimiz Dijital Dönüşüm Kutusu hizmeti küçük ve orta büyüklükteki firmalar için geliştirilmiştir.
                </TableCaption>
            </Table>
            </div>
    );
