  ...
  return (
    <section className="step-to-explation-section">
      ...
      <div className="header">
        <span className="secondary">{t("digitalConversionStepToExplation.span")}</span>
        <h2 className="step-title"> {t("digitalConversionStepToExplation.title")}</h2>
      </div>
      ...
      <div className=  {`${currentTheme === "dark" ? "w-full mx-auto digital-gridlineDark" : "w-full mx-auto digital-gridline"}`}>
        <div className="all-service flex md:justify-center">
          ...
          <div className="mask-card high-conversion rounded-sm">
            <span>
         {t("digitalConversionStepToExplation.span1")}   
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="description">
        <p>
        {t.rich("digitalConversionStepToExplation.description", {
