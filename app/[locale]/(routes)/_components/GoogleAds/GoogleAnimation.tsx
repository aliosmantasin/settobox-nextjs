...
const GoogleAnimation: React.FC<GoogleAnimationProps> = ({ onLoad }) => {
  ...
  return (
    <section className='py-20 relative overflow-hidden' aria-labelledby="google-animation-section">
      {/* Background Gradient */}
        ...
        <div className='max-w-4xl mx-auto'> 
          <div className='flex flex-wrap justify-center gap-2 mb-12'>
            ...
            <FeatureTag
              ...
              text={t('features.businessProfile')}
