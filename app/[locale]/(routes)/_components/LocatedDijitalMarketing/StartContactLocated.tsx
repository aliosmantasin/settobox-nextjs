...
export default function StartContactLocated() {
  ...
  return (
    <div className="p-2 rounded-md shadow-sm">
          <ul className="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400 block sm:flex justify-center">
            
              <li className='flex p-1 mt-1 shadow-sm'>
