    ...
    <div className="w-full max-w-full bg-white dark:bg-gray-900 p-2 rounded-md shadow">
          <ul className="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
              ...
              <li className='flex p-1'>
                <Button variant="ghost">
                  <Link href="/bilgi-alma-formu" className="flex items-center gap-2" >
                      <Mails className="h-5 w-5 text-blue-500" /> {t("webDesignProduct.miniBox.startContactWeb.mails")}
                  </Link>
                  </Button>
              </li>
              ...
              <Button variant="ghost">
                  ...
                  >
                      <MessageCircle className="h-5 w-5 text-green-500" /> {t("webDesignProduct.miniBox.startContactWeb.whatsapp")}
