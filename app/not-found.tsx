...
export default function NotFound() {
  return (
    <>
      ...
      <div className="max-w-xl mt-10 space-y-3 justify-between mx-auto">
      <Link href="/google-ads-reklam-yonetimi">
        <div className="w-full justify-between flex items-center p-3  dark:bg-gray-600 hover:bg-gray-50 border-b border-b-gray-50 pb-8">
      
            <div className="flex item-center ">
              <div className="flex my-auto mr-5"><FcGoogle className="w-16 h-16 rounded-lg border border-gray-100 shadow-sm p-3"/></div>
              <div>
              <span className="block bg-transparent my-1 text-xl text-gray-900 dark:text-white">Google Yönetimi</span>
              <span className="bg-transparent my-1 text-sm text-gray-500 dark:text-gray-400">Google Uygulamalarıya Potansiyel Müşterilerine Görünür Ol</span>
              </div>
            </div>
      ...
      <Link href="/instagram-sponsorlu-reklam">
        <div className="w-full justify-between flex items-center p-3  dark:bg-gray-600 hover:bg-gray-50 border-b border-b-gray-50 pb-8">
            ...
            <div className="flex  item-center ">
              ...
              <svg className="w-16 h-16 rounded-lg border border-gray-100 shadow-sm p-3" id="Layer_2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 85.18 56.58" width={35} height={35}>
                ...
                {/* <FcGoogle className="w-16 h-16 rounded-lg border border-gray-100 shadow-sm p-3"/> */}
                
                </div>
              <div>
              <span className="block bg-transparent my-1 text-xl text-gray-900 dark:text-white">Meta Yönetimi</span>
              <span className="bg-transparent my-1 text-sm text-gray-500 dark:text-gray-400">Markanızı Meta Gücüyle Yönlendirmesiyle Öne Çıkarın </span>
              </div>
            </div>
      ...
      <Link href="/web-sitesi-yaptirma">
        <div className="w-full justify-between flex items-center p-3  dark:bg-gray-600 hover:bg-gray-50 border-b border-b-gray-50 pb-8">
      
            <div className="flex item-center ">
              <div className="flex my-auto mr-5"><FcTemplate className="w-16 h-16 rounded-lg border border-gray-100 shadow-sm p-3"/></div>
              <div>
              <span className="block bg-transparent my-1 text-xl text-gray-900 dark:text-white">Website Tasarım Hizmeti</span>
              <span className="bg-transparent my-1 text-sm text-gray-500 dark:text-gray-400">Kurumsal Kimliğiniz Güçlendirin</span>
              </div>
            </div>
      ...
      <Link href="/dijital-pazarlama-donusum-kutusu">
        <div className="w-full justify-between flex items-center p-3  dark:bg-gray-600 hover:bg-gray-50 border-b border-b-gray-50 pb-8">
            ...
            <div className="flex item-center ">
              <div className="flex my-auto mr-5">
                <Image className=" rounded-lg border border-gray-100 shadow-sm p-3" src="/images/DigitalDonusumKutusu.webp" alt="Dijital Dönüşüm Kutusu" width={66} height={66}></Image>
                
            
                
                </div>
              <div>
              <span className="block bg-transparent my-1 text-xl text-gray-900 dark:text-white">Dijital Dönüşüm Kutusu</span>
              <span className="bg-transparent my-1 text-sm text-gray-500 dark:text-gray-400">Online Varlıkların Bütünüyle Yönetimi</span>
              </div>
            </div>
