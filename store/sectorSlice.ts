  ...
  sectorData: {
    ...
    hizmetsektoru: {
      ...
      googleManage: {
        ...
        animation: ManageGoogleAnimation, 
      },
    ...
    sagliksektoru: {
      ...
      referanceMeta: {
        ...
        metricsInfo: [
            ...
            {
                title: 'Meta Reklamları',
                description: 'Kurumsal kimliğiniz ve online varlıklarınınızın ortak içerik yapısı, reklamlar için önemli bir adım oluşturmaktadır. Bu doğrultuda bütünsel bir yaklaşımla meta reklamları planlanmaktadır.',
            }
